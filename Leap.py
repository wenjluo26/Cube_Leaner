...
class EdgeSample(Interface):
    __swig_setmethods__ = {}
    for _s in [Interface]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, EdgeSample, name, value)
    __swig_getmethods__ = {}
    for _s in [Interface]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, EdgeSample, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = LeapPython.new_EdgeSample()
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __eq__(self, arg2):
        return LeapPython.EdgeSample___eq__(self, arg2)

    def __ne__(self, arg2):
        return LeapPython.EdgeSample___ne__(self, arg2)

    def __str__(self):
        return LeapPython.EdgeSample___str__(self)
    __swig_getmethods__["position"] = LeapPython.EdgeSample_position_get
    if _newclass:
        position = _swig_property(LeapPython.EdgeSample_position_get)
    __swig_getmethods__["weight"] = LeapPython.EdgeSample_weight_get
    if _newclass:
        weight = _swig_property(LeapPython.EdgeSample_weight_get)
    __swig_getmethods__["id_left"] = LeapPython.EdgeSample_id_left_get
    if _newclass:
        id_left = _swig_property(LeapPython.EdgeSample_id_left_get)
    __swig_getmethods__["id_right"] = LeapPython.EdgeSample_id_right_get
    if _newclass:
        id_right = _swig_property(LeapPython.EdgeSample_id_right_get)
    __swig_getmethods__["is_valid"] = LeapPython.EdgeSample_is_valid_get
    if _newclass:
        is_valid = _swig_property(LeapPython.EdgeSample_is_valid_get)
    __swig_destroy__ = LeapPython.delete_EdgeSample
    __del__ = lambda self: None
EdgeSample_swigregister = LeapPython.EdgeSample_swigregister
EdgeSample_swigregister(EdgeSample)
EdgeSample.invalid = LeapPython.cvar.EdgeSample_invalid

class EdgeSampleList(Interface):
    __swig_setmethods__ = {}
    for _s in [Interface]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, EdgeSampleList, name, value)
    __swig_getmethods__ = {}
    for _s in [Interface]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, EdgeSampleList, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = LeapPython.new_EdgeSampleList()
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __len__(self):
        return LeapPython.EdgeSampleList___len__(self)

    def __getitem__(self, index):
        return LeapPython.EdgeSampleList___getitem__(self, index)

    def append(self, other):
        return LeapPython.EdgeSampleList_append(self, other)
    __swig_getmethods__["is_empty"] = LeapPython.EdgeSampleList_is_empty_get
    if _newclass:
        is_empty = _swig_property(LeapPython.EdgeSampleList_is_empty_get)
    def __iter__(self):
      _pos = 0
      while _pos < len(self):
        yield self[_pos]
    ...
    __swig_destroy__ = LeapPython.delete_EdgeSampleList
    __del__ = lambda self: None
EdgeSampleList_swigregister = LeapPython.EdgeSampleList_swigregister
EdgeSampleList_swigregister(EdgeSampleList)

class Tip(Interface):
    __swig_setmethods__ = {}
    for _s in [Interface]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, Tip, name, value)
    __swig_getmethods__ = {}
    for _s in [Interface]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, Tip, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = LeapPython.new_Tip()
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __eq__(self, arg2):
        return LeapPython.Tip___eq__(self, arg2)

    def __ne__(self, arg2):
        return LeapPython.Tip___ne__(self, arg2)

    def __str__(self):
        return LeapPython.Tip___str__(self)
    __swig_getmethods__["position"] = LeapPython.Tip_position_get
    if _newclass:
        position = _swig_property(LeapPython.Tip_position_get)
    __swig_getmethods__["radius"] = LeapPython.Tip_radius_get
    if _newclass:
        radius = _swig_property(LeapPython.Tip_radius_get)
    __swig_getmethods__["is_valid"] = LeapPython.Tip_is_valid_get
    if _newclass:
        is_valid = _swig_property(LeapPython.Tip_is_valid_get)
    __swig_destroy__ = LeapPython.delete_Tip
    __del__ = lambda self: None
Tip_swigregister = LeapPython.Tip_swigregister
Tip_swigregister(Tip)
Tip.invalid = LeapPython.cvar.Tip_invalid

class TipList(Interface):
    __swig_setmethods__ = {}
    for _s in [Interface]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, TipList, name, value)
    __swig_getmethods__ = {}
    for _s in [Interface]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, TipList, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = LeapPython.new_TipList()
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def __len__(self):
        return LeapPython.TipList___len__(self)

    def __getitem__(self, index):
        return LeapPython.TipList___getitem__(self, index)

    def append(self, other):
        return LeapPython.TipList_append(self, other)
    __swig_getmethods__["is_empty"] = LeapPython.TipList_is_empty_get
    if _newclass:
        is_empty = _swig_property(LeapPython.TipList_is_empty_get)
    def __iter__(self):
      _pos = 0
      while _pos < len(self):
        yield self[_pos]
    ...
    __swig_destroy__ = LeapPython.delete_TipList
    __del__ = lambda self: None
TipList_swigregister = LeapPython.TipList_swigregister
TipList_swigregister(TipList)
...
class Frame(Interface):
    ...
    __swig_getmethods__["edge_samples"] = LeapPython.Frame_edge_samples_get
    if _newclass:
        edge_samples = _swig_property(LeapPython.Frame_edge_samples_get)
    __swig_getmethods__["tips"] = LeapPython.Frame_tips_get
    if _newclass:
        tips = _swig_property(LeapPython.Frame_tips_get)
...
class Controller(Interface):
    ...
    POLICY_EDGE_SAMPLES = LeapPython.Controller_POLICY_EDGE_SAMPLES
    POLICY_TIPS = LeapPython.Controller_POLICY_TIPS
